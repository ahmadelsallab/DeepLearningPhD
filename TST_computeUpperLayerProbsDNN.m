...
% Output:
% mUpperProbs: The output probs. Matrix (nxl)where n is the number of examples and l is the number of target classes
function [mUpperProbs] = TST_computeUpperLayerProbsDNN(mBatchData, nNumTargets, NM_strNetParams, nBitfieldLength, vChunkLength, vOffset, eFeaturesMode)
    ...
    for ctrBatch = 1 : nNumBatches
        ...
        mUpperProbs = [mUpperProbs; mCurrBatchTargetOut./repmat(sum(mCurrBatchTargetOut,2), 1, nNumTargets)];
