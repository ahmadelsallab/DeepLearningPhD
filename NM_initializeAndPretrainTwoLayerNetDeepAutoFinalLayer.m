...
function [cWeights, mHiddenActivations] = NM_initializeAndPretrainTwoLayerNetDeepAutoFinalLayer(cWeights, vLayersWidths, nPrevNumLayers, ctrLayer,...
    ...
    [mHiddenActivations, mWeights, vSecodLayerBiases, vFirstLayerBiases] = NM_preTrainTwoLayerNetDeepAutoFinalLayer(mWeights, vSecodLayerBiases, mVisibleActivations, nPreTrainEpochs, nSecodLayerWidth, hFidLog, nBitfieldLength, vChunkLength, vOffset, eFeaturesMode, ctrLayer);
