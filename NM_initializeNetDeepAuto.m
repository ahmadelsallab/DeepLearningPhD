...
function [NM_strNetParams] = NM_initializeNet(bMapping, eMappingMode, eMappingDirection, bDepthCascadedDataRepMode,...
        ...
        for ctrLayer = 1 : (NM_strNetParams.nNumLayers)
            ...
            if(ctrLayer ~= (NM_strNetParams.nNumLayers))
                [NM_strNetParams.cWeights, mHiddenActivations] = NM_initializeAndPretrainTwoLayerNetDeepAuto(NM_strNetParams.cWeights, NM_strNetParams.vLayersWidths,...
                                                                                                             ...
                                                                                                             nBitfieldLength, vChunkLength, vOffset, eFeaturesMode, NM_strNetParams.nNumLayers);
            else
                [NM_strNetParams.cWeights, mHiddenActivations] = NM_initializeAndPretrainTwoLayerNetDeepAutoFinalLayer(NM_strNetParams.cWeights, NM_strNetParams.vLayersWidths,...
                                                                                                                     NM_strNetParams.nPrevNumLayers, ctrLayer, bMapping,...
                                                                                                                     nPreTrainEpochs, mVisibleActivations, hFidLog,...
                                                                                                                     eMappingMode, eMappingDirection, bDepthCascadedDataRepMode,...
                                                                                                                     nBitfieldLength, vChunkLength, vOffset, eFeaturesMode, NM_strNetParams.nNumLayers);
