...
% corresponding index.
function [nErr, vTargetOut, vTargets] = TST_computeClassificationErrDNN(mBatchData, mBatchTargets, NM_strNetParams, bMapping, eMappingDirection, eMappingMode,...
                                                              nPhase, nNumPhases, eTestMode, nBitfieldLength, vChunkLength, vOffset, eFeaturesMode)
    ...
    for ctrBatch = 1 : nNumBatches
        ...
        % Update the desired targets
        vTargets = [vTargets; J1];
