...
function [mHiddenActivations, mWeigths, vSecodLayerBiases] = NM_preTrainTwoLayerNet(mWeigths, vSecodLayerBiases, mVisibleActivations, nPreTrainEpochs, nSecodLayerWidth, hFidLog, nBitfieldLength, vChunkLength, vOffset, eFeaturesMode)
