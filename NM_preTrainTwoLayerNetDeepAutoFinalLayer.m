...
function [mHiddenActivations, mWeigths, vSecodLayerBiases, vFirstLayerBiases] = NM_preTrainTwoLayerNetDeepAutoFinalLayer(mWeigths, vSecodLayerBiases, mVisibleActivations, nPreTrainEpochs, nSecodLayerWidth, hFidLog, nBitfieldLength, vChunkLength, vOffset, eFeaturesMode, ctrLayer)
