classdef maxent
    ...
    methods
        function obj = maxent(varargin)
        % MAXENT  MaxEnt constructor
        %
        % obj = MAXENT(L,M) where L is the number of labels, M is the number
        % of features
        %
        % obj = MAXENT Creates an empty/default object
        % obj = MAXENT(A) where A is a MaxEnt object will return a copy of A
